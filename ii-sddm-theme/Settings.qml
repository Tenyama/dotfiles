...
QtObject {
    ...
    property string time_format: "hh:mm" // "hh:mm","h:mm ap","h:mm AP"
    property string background_widgets_clock_styleLocked: "digital" // "none", "digital", "cookie"
    property string background_widgets_clock_digital_font_family: "BigBlueTermPlus Nerd Font" // "any font installed systemwide" 
